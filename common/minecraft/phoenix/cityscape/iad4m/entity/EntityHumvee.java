...
public class EntityHumvee extends Entity
{
    ...
    public EntityHumvee(World par1World)
    {
        super(par1World);
    ...
    public EntityHumvee(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (l = 0; l < list.size(); ++l)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityHumvee)
                        {
