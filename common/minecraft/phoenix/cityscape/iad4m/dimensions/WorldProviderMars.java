...
{
this.worldChunkMgr = new WorldChunkManagerHell(iAd4m.mars, this.dimensionId, this.dimensionId);
this.dimensionId = iAd4m.marsid;
this.hasNoSky = false;
}
public IChunkProvider createChunkGenerator()
{
return new ChunkProviderMars(this.worldObj, this.worldObj.getSeed(), false);
}
...
{
if ((this instanceof WorldProviderMars))
{
