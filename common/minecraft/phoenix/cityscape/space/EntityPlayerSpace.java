...
public class EntityPlayerSpace extends PlayerBase
{
	...
	public void onLivingUpdate()
	{
		if(player.dimension == Space.space)
		{
			...
			{
				if (boots.itemID == CivilizationSpace.SpaceBoots.itemID
						&& legs.itemID == CivilizationSpace.SpaceLegs.itemID
						&& chest.itemID == CivilizationSpace.SpaceChest.itemID
						&& helm.itemID == CivilizationSpace.SpaceHelmet.itemID)
				{
					moonAir = maxAir;
				}
			}
